...
The aim was a cloud service enabling FxBlox owners and non-owners to use decentralized cloud storage as easily as with big cloud companies. 
...
For non-technical people who want to join the movement by providing storage, a simple app makes it easy to set up the device. 
...
[WNFS](https://fission.codes/ecosystem/wnfs/) is layered on top to enable encryption over IPFS, public and private file sharing, as well as decentralized authentication and identity.
