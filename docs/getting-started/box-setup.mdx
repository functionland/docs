...
Before we can install and run box locally you should have [`node>=16 <17`](https://nodejs.org/en/download/)
first install box
```
...
```
Note: if you use node 17 you can downgrade your npm to 6 and it works.
</TabItem>
</Tabs>
