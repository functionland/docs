...
You should consider using this process if you intend to make "substantial" changes in any Fula Network project or the documentation. Here are some examples of things that would benefit from an RFC:
...
- The introduction of a new idea, concept or convention that is currently not present in the Fula Network.
...
## About the process
In short, to get a major feature added to any of the Fula Network projects, you would first get the RFC merged into the RFC repo of that project as a markdown file.  At that point the RFC is ‘active’ and may be implemented with the goal of eventual inclusion.
